...
Large Language Models (LLMs) can serve as automated coders, shifting content analysis from dictionary-based methods to zero-shot and few-shot classification [@10.1162/coli_a_00502]. This paradigm shift enables the replication of human-like annotation at scale, bridging the gap between quantitative metrics and qualitative interpretation [@10.1162/coli_a_00502].
